...
3. 입력 형식 검증된 문자열 -> Map<String, Integer>
4. Map<String, Integer> -> EnumMap<Menu, Integer>
5. EnumMap<Menu, Integer> -> OrderedMenu 객체

이 모든 기능을 도메인, View, Controller, domain, Util 등 어떤 패키지에서 어떤 클래스가 동작해야 하는지 생각해봤다.
